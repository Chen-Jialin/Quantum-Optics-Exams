...
\begin{sol}
    \begin{itemize}
        ...
        \begin{align}
            ...
            \notag=&\frac{\abs{N}^2}{2}[(\alpha^2+(\alpha^*)^2+1)(1+\exp(-2\abs{\alpha}^2))+\abs{\alpha}^2(1-\exp(-2\abs{\alpha}^2)]\\
            =&\frac{1}{4}\left[1+\alpha^2+(\alpha^*)^2+\abs{\alpha}^2\frac{1-\exp(-2\abs{\alpha}^2)}{1+\exp(-2\abs{\alpha}^2)}\right],
        \end{align}
        由于 $\alpha$ 为纯虚数, 故
        \begin{align}
            \langle X_1^2\rangle=\frac{1}{4}\left[1-\abs{\alpha}^2\frac{1+3\exp(-2\abs{\alpha}^2)}{1+\exp(-2\abs{\alpha}^2)}\right]<\frac{1}{4}.
        \end{align}
        $X_1$ 的涨落为
        \begin{align}
